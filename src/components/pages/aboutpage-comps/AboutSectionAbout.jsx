      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-24 lg:py-0 lg:flex-row lg:gap-8">
        ...
        <div className="flex flex-col justify-center items-center h-[85%] md:h-full">
          ...
          <p className="text-md md:text-lg text-gray-300 py-4 max-x-md text-justify">
            I am a professional graduate from Domingo Sabio University, holding
            degrees in Systems Engineering and Electronics Technology from
            Tecnológico Puerto de Mejillones.
          </p>

          <p className="text-md md:text-lg text-gray-300 max-x-md text-justify">
            I embarked on my journey by working in the repair of electronic
            devices and cell phones. My affinity for technology has always been
            evident, and now I am dedicated to studying and refining my skills
            in the exciting realm of programming, with a special focus on
